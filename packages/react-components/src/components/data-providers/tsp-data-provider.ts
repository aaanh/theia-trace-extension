...
export class TspDataProvider {
    ...
    async getDataForSyncAnalysis(
        ...
        return {
            id: 'model',
            totalLength: selectionDuration, // Use selection duration as total length
            rows,
            arrows,
            rangeEvents,
            data: {
    ...
    private normalizeTimeForSyncAnalysis(time: bigint, selectionStart: bigint, selectionDuration: bigint): bigint {
        // Map time from absolute coordinates to normalized coordinates (0 to selectionDuration)
        // The selection range maps to 0 to selectionDuration
