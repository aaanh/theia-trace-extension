...
export class TraceContextComponent extends React.Component<TraceContextProps, TraceContextState> {
    ...
    constructor(props: TraceContextProps) {
        ...
        this.unitController.numberTranslator = createNumberTranslator(() => this.state.currentRange.getStart());
                ...
                {outputs.map(output => {
                    ...
                    switch (responseType) {
                        ...
                        case 'GANTT_CHART': {
                            ...
                            ganttChartUnitController.numberTranslator = createNumberTranslator(() =>
                                this.state.currentRange.getStart()
                            );
                            ...
                            return (
                                <GanttChartOutputComponent
                                    key={`${output.id}-${this.state.ganttChartResetZoomKey}`}
                                    {...outputProps}
                                    menuId="ganttchart.menuId"
